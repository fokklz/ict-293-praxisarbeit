...
function calcItemMeta() {
  ...
  let maxWidth = breakpoints[index] - 30;
  ...
  let itemMargin = (maxWidth - maxItems * width) / 2;
  ...
  return [width, maxItems, finalMargin, maxWidth];
}
...
function updateRatings() {
  ...
  if (meta[1] == 1) {
    ratingInner.setAttribute('data-view', meta[3] + 2 * meta[2]);
  } else {
